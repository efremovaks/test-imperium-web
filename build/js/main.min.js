...
/* harmony import */ var _modules_init_intro_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-intro-slider */ "./js/modules/init-intro-slider.js");
/* harmony import */ var _modules_init_promo_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-promo-slider */ "./js/modules/init-promo-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_intro_slider__WEBPACK_IMPORTED_MODULE_4__["initIntroSlider"])();
  Object(_modules_init_promo_slider__WEBPACK_IMPORTED_MODULE_5__["initPromoSlider"])();
...
/*!*****************************************!*\
  !*** ./js/modules/init-intro-slider.js ***!
  \*****************************************/
/*! exports provided: initIntroSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initIntroSlider", function() { return initIntroSlider; });
var sliderBlocks = document.querySelectorAll('.intro__slider');
var initIntroSlider = function initIntroSlider() {
  if (!sliderBlocks) {
    return;
  }
  sliderBlocks.forEach(function (sliderBlock) {
    var sliderContainer = sliderBlock.querySelector('.intro__container');
    var sliderPhoto = new Swiper(sliderContainer, {
      loop: true,
      slidesPerView: 'auto',
      slidesPerGroup: 1,
      spaceBetween: 180,
...
/***/ "./js/modules/init-promo-slider.js":
/*!*****************************************!*\
  !*** ./js/modules/init-promo-slider.js ***!
  \*****************************************/
...
var sliderBlocks = document.querySelectorAll('.promo__slider');
var initPromoSlider = function initPromoSlider() {
  if (!sliderBlocks) {
    return;
  }
  sliderBlocks.forEach(function (sliderBlock) {
    var sliderContainer = sliderBlock.querySelector('.promo__container');
    var sliderPhoto = new Swiper(sliderContainer, {
      loop: true,
      slidesPerView: 4,
      slidesPerGroup: 4,
